...
> [!NOTE]
> Once this package is [published to npm](https://app.stainlessapi.com/docs/guides/publish), this will become: `npm install cadenza-lite`
...
- Deno v1.28.0 or higher, using `import Cadenza from "npm:cadenza-lite"`.
- Bun 1.0 or later.
- Cloudflare Workers.
- Vercel Edge Runtime.
